...
class DepthOfField34 extends PostEffectsBase {
	...
	private var go: GameObject; //editado thiago
	var touchedGameObject : GameObject;	//tb
	
	function Start()
	{
		touchedGameObject = Camera.main.gameObject;
	}
	...
	//Funçao que funciona como evento que e disparada pelo RaycastClick.cs	
	function RayCastTouch(hit : RaycastHit)
	{
	...
	//	if (touchedGameObject.name == "Plane")
	//	{
			go = GameObject.Find(touchedGameObject.name);
			flag = 2;
	//	}
	/*
		if (touchedGameObject.name == "Cube")
		{
			go = GameObject.Find("Cube");
			flag = 2;
		}
		if (touchedGameObject.name == "Sphere")
		{
			go = GameObject.Find("Sphere");
			flag = 2;
		}
		if (touchedGameObject.name == "Capsule")
		{
			go = GameObject.Find("Capsule");
			flag = 2;
		}
		if (touchedGameObject.name == "")
		{
			objectFocus = null;
			flag = 1;
		}
